...
public class MultiWindowTest {
    ...
    //// Print each test case name in a Toast
    //
    ...
    public void showToast() {
        try {
            runOnUiThread(new Runnable() {
                public void run() {
                    Toast.makeText(InstrumentationRegistry.getInstrumentation().getTargetContext(), name.getMethodName(), Toast.LENGTH_SHORT).show();
                }
            });
        } catch (Throwable e) {
            Log.d("showToastException", e.getMessage());}
    }
